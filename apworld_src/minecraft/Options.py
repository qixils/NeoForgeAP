...
class UnlockableHearts(Toggle):
    """Start players with one heart and add nine Heart items to the item pool. Each Heart restores one max heart, up to the vanilla ten hearts."""
    display_name = "Unlockable Hearts"
...
class MinecraftOptions(PerGameCommonOptions):
    ...
    unlockable_hearts: UnlockableHearts
