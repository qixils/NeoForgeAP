...
public class APRegistries {
    ...
    public static final ResourceKey<Registry<MapCodec<? extends CompassTarget>>> COMPASS_TARGET_TYPE = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(APRandomizer.MODID, "compass_target_type"));
}
