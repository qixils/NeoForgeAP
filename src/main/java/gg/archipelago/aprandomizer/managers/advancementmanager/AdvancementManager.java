...
public class AdvancementManager {
    ...
    private final Object2LongMap<ResourceLocation> advancementData = Util.make(new Object2LongOpenHashMap<>(), map -> {
        ...
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/get_wood"), 42080L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/get_pickaxe"), 42081L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/hot_topic"), 42082L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/bake_bread"), 42083L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/the_lie"), 42084L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/ride_minecart"), 42085L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/craft_sword"), 42086L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/cow_tipper"), 42087L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/ride_pig"), 42088L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/overkill"), 42089L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/obtain_bookshelf"), 42090L);
        map.put(ResourceLocation.fromNamespaceAndPath("minecraft", "archipelago/overpowered"), 42091L);
