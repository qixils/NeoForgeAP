...
public class AdvancementManager {
    ...
    private static final Object2LongMap<ResourceKey<APLocation>> DEFAULT_LOCATIONS = Util.make(new Object2LongOpenHashMap<>(), map -> {
        ...
        // 1.21 advancements
        map.put(APLocations.VANILLA_ADVENTURE_MINECRAFT_TRIALS_EDITION, 42126L);
        map.put(APLocations.VANILLA_ADVENTURE_UNDER_LOCK_AND_KEY, 42127L);
        map.put(APLocations.VANILLA_ADVENTURE_BLOWBACK, 42128L);
        map.put(APLocations.VANILLA_ADVENTURE_WHO_NEEDS_ROCKETS, 42129L);
        map.put(APLocations.VANILLA_ADVENTURE_CRAFTERS_CRAFTING_CRAFTERS, 42130L);
        map.put(APLocations.VANILLA_ADVENTURE_LIGHTEN_UP, 42131L);
        map.put(APLocations.VANILLA_ADVENTURE_OVEROVERKILL, 42132L);
        map.put(APLocations.VANILLA_ADVENTURE_REVAULTING, 42133L);
        // 1.21.6 advancements
